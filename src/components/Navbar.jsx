...
export default function Navbar() {
  ...
  return (
    <section className='h-22 relative'>
      <nav
        className={`fixed w-full h-22 top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-secondary/95 backdrop-blur-md shadow-subtle py-2' : 'bg-secondary py-2 shadow-subtle'
          }`}
      >
              ...
              <div className="flex items-center gap-1">
                {navItems.map((item, index) => (
                  ...
                  >
                    <Link
                      to={item.path}
                      className={`px-3 py-2 text-sm font-bold flex items-center gap-2 transition-all duration-300 rounded-lg ${location.pathname === item.path
              ...
              {navItems.map((item, index) => (
                ...
                >
                  <Link
                    ...
                    className={`block px-4 py-3 text-base font-bold flex items-center gap-3 rounded-lg transition-all duration-300 ${location.pathname === item.path
