  ...
  return (
    <AnimatedPageWrapper>
      {/* Enhanced Hero Section */}
        <motion.section 
          className="relative py-24 overflow-hidden bg-gradient-to-br from-secondary to-accent/10"
        ...
        {/* Enhanced Filters */}
        <motion.section 
          className="py-6 bg-white/80 backdrop-blur-sm border-b border-subtle sticky top-0 z-20 shadow-sm"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row gap-4 items-center">
              ...
              >
                <select
                  className="appearance-none pl-4 pr-10 py-3 bg-white/70 backdrop-blur-sm border border-subtle rounded-xl text-primary focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent shadow-sm hover:shadow-md transition-all duration-300 font-medium"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
              {blogPosts
                ...
                .map((post, index) => (
                  <motion.div
                    key={post.id}
                    className="bg-gradient-to-br from-white to-secondary rounded-3xl overflow-hidden border border-subtle hover:border-accent transition-all duration-500 group shadow-lg hover:shadow-xl"
                    initial={{ opacity: 0, y: 30 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <div className="h-64 bg-gradient-to-r from-accent to-primary flex items-center justify-center relative">
                      ...
                      <div className="text-center z-10">
                        ...
                        <p className="text-white font-bold text-lg">Featured Article</p>
                      </div>
                      <div className="absolute top-4 right-4 bg-accent text-white px-3 py-1 rounded-full text-sm font-bold flex items-center">
                    ...
                    <div className="p-6">
                      <div className="flex items-center text-sm mb-3">
                        <span className="px-3 py-1 bg-accent text-white rounded-lg font-bold text-sm">{post.category}</span>
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-subtle">
                        ...
                        <Link 
                          to={`/blog/${post.id}`} 
                          className="w-10 h-10 rounded-full bg-accent flex items-center justify-center text-white hover:bg-primary transition-all duration-300 shadow-md group-hover:shadow-lg"
                        >
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {filteredPosts.map((post, index) => (
                    <motion.div
                      key={post.id}
                      className="bg-white rounded-2xl overflow-hidden border border-subtle hover:border-accent transition-all duration-300 group shadow-sm hover:shadow-lg"
                      initial={{ opacity: 0, y: 30 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ duration: 0.5, delay: 0.5 + index * 0.1 }}
                      whileHover={{ y: -6 }}
                ...
                >
                  <button className="px-8 py-4 bg-gradient-to-r from-accent to-primary text-white rounded-xl hover:from-primary hover:to-accent transition-all duration-300 font-bold shadow-lg hover:shadow-xl transform hover:scale-105">
                    Load More Articles
                  </button>
                </motion.div>
              </>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            >
              <div className="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full mb-6 border border-white/30">
                ...
                <span className="text-white font-bold text-sm">SUBSCRIBE TO OUR NEWSLETTER</span>
              </div>
              
              <h2 className="text-4xl md:text-5xl font-black text-white mb-6 leading-tight">
                Stay Updated with <span className="bg-gradient-to-r from-white to-secondary bg-clip-text text-transparent">Our Latest Insights</span>
              </h2>
              ...
              <div className="mt-10 max-w-lg mx-auto">
                <form className="flex flex-col sm:flex-row gap-4">
                  ...
                  <motion.button
                    type="submit"
                    className="px-8 py-4 bg-white text-primary font-bold rounded-xl hover:bg-secondary transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
